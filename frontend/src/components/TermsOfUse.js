...
const TermsOfUse = () => {
  return (
    ...
    >
      ...
      <h2 style={{ fontSize: '24px', marginTop: '30px' }}>1. Introduction</h2>
      <p>
      ...
      <h2 style={{ fontSize: '24px', marginTop: '30px' }}>2. Usage Conditions</h2>
      <ul>
      ...
      <h2 style={{ fontSize: '24px', marginTop: '30px' }}>3. Prohibited Actions</h2>
      <ul>
      ...
      <h2 style={{ fontSize: '24px', marginTop: '30px' }}>6. Service Modification and Termination</h2>
      <p>
      ...
      <h2 style={{ fontSize: '24px', marginTop: '30px' }}>8. Contact Information</h2>
      <p>
