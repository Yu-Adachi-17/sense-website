    ...
    <>
      ...
      >
        ...
        <main className="mx-auto max-w-3xl px-6 pb-20">
          ...
          {/* What is negotiation */}
          <SectionCard className="mt-8">
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight">{t("negotiation.h2")}</h2>
            <p className="mt-2 text-base leading-7 text-indigo-100/90">{t("negotiation.p1")}</p>
          </SectionCard>
          ...
          <SectionCard className="mt-8">
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight">{t("example.h2")}</h2>
            <div className="mt-3 rounded-2xl border border-white/10 bg-black/30 p-4">
              <pre className="whitespace-pre-wrap text-sm leading-6 text-indigo-100/90 font-mono">
{t("example.block")}
              </pre>
            </div>
            <p className="mt-3 text-base leading-7 text-indigo-100/90">{t("example.p1")}</p>
          </SectionCard>
