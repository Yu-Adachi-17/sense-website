      ...
      <main className="scene">
        ...
        <style jsx>{`
          ...
          .legalRow {
            ...
            display: flex;
            align-items: center;
            justify-content: center; /* Terms/Privacy は中央 */
            gap: 12px;
          }
          .legal {
            display: inline-flex;
          ...
          @media (max-width: 900px) {
            .legalRow { flex-direction: column; }
            .copyright { position: static; margin-top: 6px; }
        ...
        <style jsx global>{`
          :root { --header-h: clamp(56px, 9vh, 72px); }

          header.top{
            height: var(--header-h);
            left:0; top:0; right:0;
            z-index:10; display:flex; justify-content:space-between; align-items:center;
            padding: 0 22px; /* 高さは固定し、上下は0で揃える */
          }
          .headerSpacer{ height: var(--header-h); } /* ← これで重なり解消 */
