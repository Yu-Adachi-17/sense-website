...
app.post('/api/minutes-email-from-audio', upload.single('file'), async (req, res) => {
  ...
  try {
    ...
    const textBody = [
      'Hi,',
      '',
      'Here are your meeting minutes generated by Minutes.AI.',
      '',
      ...
      transcription.length > 500
        ...
        : transcription,
      '',
      '--- MINUTES (JSON or text) ---',
      typeof minutes === 'string'
        ? minutes.slice(0, 2000)
        : JSON.stringify(minutes).slice(0, 2000),
      '',
      'Best regards,',
      'Minutes.AI',
    ].join('\n');
    ...
    const htmlBody = `
      <p>Hi,</p>
      <p>Here are your meeting minutes generated by <strong>Minutes.AI</strong>.</p>
      <hr/>
      <p><strong>Transcript (truncated):</strong></p>
...
${(typeof minutes === 'string'
  ...
  .replace(/>/g, '&gt;')}
      ...
      <hr/>
      <p>Best regards,<br/>Minutes.AI</p>
    `;
